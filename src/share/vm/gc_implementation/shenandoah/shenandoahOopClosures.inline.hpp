...
#include "gc_implementation/shenandoah/shenandoahTraversalGC.inline.hpp"
...
inline void ShenandoahTraversalSuperClosure::work(T* p) {
  _traversal_gc->process_oop<T, STRING_DEDUP, DEGEN, ATOMIC_UPDATE>(p, _thread, _queue, _mark_context, _dedup_queue);
}
