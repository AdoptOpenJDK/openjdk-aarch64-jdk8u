...
BASE_PATHS="${BASE_PATHS} ${COMMONSRC}/share/vm/prims/wbtestmethods ${COMMONSRC}/share/vm/gc_implementation/shenandoah/heuristics ${COMMONSRC}/share/vm/gc_implementation/shenandoah/mode"
